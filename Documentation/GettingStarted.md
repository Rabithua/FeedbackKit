...
at `2.1.0`. Existing integrations should follow
[Migrating to FeedbackKit 2.1](MigratingTo2.1.md).
...
FeedbackKit 2.1 requires iOS 18 or macOS 15 and Swift 6 language mode.
