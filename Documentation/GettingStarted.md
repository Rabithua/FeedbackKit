...
at `3.0.0`. Existing integrations should follow
[Migrating to FeedbackKit 3.0](MigratingTo3.0.md).
...
FeedbackKit 3.0 requires iOS 18 or macOS 15 and Swift 6 language mode.
